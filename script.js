...
let inventorNames = inventors.map((inventor) => {
    return {first: inventor.first, last: inventor.last,} //key colon value comma
});
...
// accumulator is the holder of the value as it iterates through inventor
// the 0 indicates the initial value of the accumulator
// accumulator can be represented by any variable name
